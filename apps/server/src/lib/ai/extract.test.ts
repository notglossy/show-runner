...
describe("GenerateScreenRequestSchema", () => {
  ...
  it("accepts minimal and full requests, trimming strings", () => {
    ...
    expect(full).toEqual({ instruction: "make it bigger", currentHtml: "<style></style><p>x</p>", model: "google/gemini-3.8-flash", previewErrors: ["TypeError: x"] });
